...
task ampseq_dada2_iseq_process {
	...
	echo "CHECK"
	python /Code/Amplicon_TerraPipeline.py --config ~{config_json} --mixed_reads --meta --repo --adaptor_removal --dada2 --postproc_dada2 #--asv_to_cigar
	...
	runtime {
		...
		preemptible: 3
		maxRetries: 1
		docker: 'jorgeamaya/dada2_terra_iseq@sha256:601e62437598cd2da20baa415523bb98c94008ccf29e3354b74488c047422c68'
	}
}
